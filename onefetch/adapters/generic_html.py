...
class GenericHtmlAdapter(BaseAdapter):
    ...
    def _looks_like_login_required(content: str, body_text: str, *, title: str | None = None) -> bool:
        ...
        # Raw HTML in extracted content is a strong signal that readable content was not extracted.
        if text.startswith("<!doctype html") or ("<html" in text and "<head" in text):
            return True
        # 标题明确含登录/注册
